...
public class CustomerJFrame extends javax.swing.JFrame {
     ...
     */
    public CustomerJFrame(Business biz, UserAccount useraccount) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Customer c = this.biz.getCustomerDirectory().findbyID(useracc.getAccountID());
        Order o = this.biz.getAllOrders().requestOrder(c);
        c.addDeliveryOrder(o);
